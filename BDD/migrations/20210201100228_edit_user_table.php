...
class mig_20210201100228_edit_user_table
{
    ...
    public function up()
    {
        ...
        $this->dbHandle->query('ALTER TABLE `users` CHANGE `user_psw` `user_password` VARCHAR(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL AFTER `id_center`');
