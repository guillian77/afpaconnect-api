...
class fix_20210706080746_initialize_users
{
    ...
    public function exec()
    {
        ...
        foreach ($users as $user)
        {
            ...
            VALUES ('1', '1', :identifier, :lastname, :firstname, :emailPro, :emailPerso, :password, '0102030405', '15 rue de ladmin', 'Bâtiment A', '34000', 'Montpellier', 'France', '1','350-Cons Rég hors convention tripartite', '97014200270-PRF 2021 - QUALIF PRO - BC 19Q04351232_6 - PIC', '1', '2021-02-01', '2021-02-01 13:43:25')";
